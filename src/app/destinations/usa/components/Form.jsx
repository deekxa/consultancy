...
export default function FormUSA({ open, course, onClose }) {
      ...
      <div className="bg-white rounded-2xl p-6 sm:p-7 w-full max-w-2xl relative shadow-xl border border-[#e6def8]">
        ...
        <div className="mb-4 text-left">
          <h2 className="text-xl sm:text-2xl font-bold text-[#110053]">
            Apply for this USA course
          </h2>
          <p className="mt-1 text-xs sm:text-sm text-[#4a4560]">
            Fill in your details and our counselor will contact you about{" "}
            ...
            <FormikForm className="flex flex-col gap-4 text-left w-full">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex flex-col gap-1">
                  ...
                  <Field
                    ...
                    className="w-full rounded-lg px-3 py-2 border border-[#e6def8] text-sm focus:outline-none focus:ring-2 focus:ring-[#8b7ae8]/60"
                  />
                  <ErrorMessage
                    name="name"
                    component="div"
              ...
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  disabled
                  className="w-full rounded-lg px-3 py-2 border border-[#e6def8] text-sm bg-[#f0edff] text-[#4a4560]"
                />
              </div>
              ...
              <div className="mt-3 flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
                <button
                  type="button"
                  onClick={onClose}
                  className="w-full sm:w-auto px-4 py-2 text-xs font-medium text-[#4a4560] border border-[#e6def8] rounded-lg hover:bg-[#f6f4ff] transition-colors"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="w-full sm:w-auto px-6 py-2 bg-gradient-to-r from-[#8b7ae8] to-[#a89fff] text-xs font-semibold text-white rounded-lg shadow hover:shadow-md hover:scale-[1.02] transition disabled:opacity-60 disabled:cursor-not-allowed"
                >
