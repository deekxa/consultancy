...
import FAQSectionKorea from "./components/FAQSectionKorea";
  ...
  const cardConfig = [
    {
      ...
      items: [
        ...
        "Highly advanced technology & innovation",
    ...
    },
    {
      title: "Key Facts",
      items: [
        "Language: Korean / English (some programs)",
        "Levels: UG, PG, Diploma, Research",
    ...
    },
    {
      ...
      items: [
        ...
        "University-specific entrance exams (some)",
      ],
    },
    {
      title: "Typical Costs",
      items: [
        "UG: $3,000 – $10,000 / year",
        "PG: $4,000 – $12,000 / year",
        "Living Cost: $600 – $1,000 / month",
      ],
    },
    {
      title: "Timeline & Visa",
      items: [
        "Main intakes: March & September",
        "Visa: D-2 (study) + D-4 (language)",
    ...
    },
    {
      title: "Requirements",
      items: [
        "Valid passport & academic documents",
        "Financial proof (~$9,000+ balance)",
        "TOPIK/English score if required",
        "Medical check (TB test)",
      ],
    },
    {
      title: "Scholarships",
      items: [
        ...
        "University President/Dean Scholarships",
        "Tuition Fee Waivers (30%–100%)",
      ],
    },
    {
      title: "Why Korea?",
      items: [
        ...
        "Top global tech & research hub",
        "Strong career & work opportunities",
        "Rich culture & global influence",
      ],
    },
  ];
...
<section className="relative w-full min-h-[550px] flex items-center justify-center overflow-hidden mb-0">
  {/* Background Image */}
  <img
    src="/country/korea3.jpg"
    alt="Study in Korea hero"
  ...
  <div className="relative z-10 w-full px-6 lg:px-16 py-20 flex flex-col items-center text-center animate-slideUp">
    ...
    <p className="mt-4 max-w-2xl text-base sm:text-lg text-white/80">
      Explore universities, visa options, and everything you need to start your Korea study journey.
    </p>
  </div>
  ...
  <div className="absolute bottom-0 left-0 w-full backdrop-blur-sm bg-white/[0.02] border-t border-white/5 py-4 animate-slideUpBreadcrumb">
    <nav className="max-w-7xl mx-auto px-6 lg:px-16 flex items-center gap-3 text-base sm:text-lg font-bold">
      ...
      <span className="text-[#a89fff] font-extrabold drop-shadow-[0_2px_8px_rgba(0,0,0,0.4)]">Korea</span>
    </nav>
  </div>
</section>
