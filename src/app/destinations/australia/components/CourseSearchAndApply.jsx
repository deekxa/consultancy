...
const DATA = [
  {
    id: 1,
    title:
      "Foundation Studies Standard Program, Life Science Stream, Bachelor of Science in Pharmacology",
    institution: "UNSW College",
    logo: "/logos/unsw-global.png",
    tuitionFee: "42700 AUD",
  ...
  },
  {
    ...
    logo: "/logos/unsw.png",
    tuitionFee: "34500 AUD",
    applicationFee: "AUD 120",
    duration: "24 months",
    intakes: "February, July",
    postStudyWork: true,
    englishScore: "7.0",
...
export default function CourseSearchAndApply() {
    ...
    <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 pt-2 text-center">
      ...
      >
        <input
          ...
          placeholder="Search courses or universities in Australia..."
        />
        <select
          value={intake}
