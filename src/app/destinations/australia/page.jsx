...
import FAQSectionAustralia from "./components/FAQSectionAustralia";
...
export default function AustraliaPage() {
  ...
  const cardConfig = [
    { title: "Benefits", items: ["Top universities", "Modern campuses", "Global degree"] },
    { title: "Key Facts", items: ["English", "UG/PG/Vocational", "Visa subclass 500"] },
    { title: "Exam Requirements", items: ["IELTS", "TOEFL", "PTE"] },
    { title: "Typical Costs", items: ["UG: 20k–45k", "PG: 22k–50k", "Living: 20k–27k"] },
    { title: "Timeline & Visa", items: ["Feb–Jun", "Jul–Nov", "Counseling → Visa"] },
    { title: "Requirements", items: ["Financial proof", "English score", "GTE", "Insurance"] },
    { title: "Scholarships", items: ["Australia Awards", "Endeavour", "RTP"] },
    { title: "Why Australia?", items: ["Safe", "Diverse", "PR options", "Modern cities"] },
  ];
...
<section className="relative w-full min-h-[550px] flex items-center justify-center overflow-hidden mb-0">
  <img
    src="/country/Australia2.jpg"
    alt="Study in Australia hero"
  ...
  <div className="relative z-10 w-full px-6 lg:px-16 py-20 flex flex-col items-center text-center animate-slideUp">
    ...
    <p className="mt-4 max-w-2xl text-base sm:text-lg text-white/80">
      Explore universities, visa options, and everything you need to start your Australian study journey.
    </p>
  </div>
  ...
  <div className="absolute bottom-0 left-0 w-full backdrop-blur-sm bg-white/[0.02] border-t border-white/5 py-4 animate-slideUpBreadcrumb">
    <nav className="max-w-7xl mx-auto px-6 lg:px-16 flex items-center gap-3 text-base sm:text-lg font-bold">
      ...
      <span className="text-[#a89fff] font-extrabold drop-shadow-[0_2px_8px_rgba(0,0,0,0.4)]">Australia</span>
    </nav>
  </div>
</section>
