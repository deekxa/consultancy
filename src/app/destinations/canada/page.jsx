...
import CourseSearchAndApplyCanada from "./components/CourseSearchAndApply";
import FAQSectionCanada from "./components/FAQSectionCanada";
import FAQsectionCanada from "./components/FAQSectionCanada";
...
export default function CanadaPage() {
  ...
  const cardConfig = [
    {
      title: "Benefits",
      items: ["Top-ranked universities", "Safe & welcoming", "PR pathways"],
    },
    {
      title: "Key Facts",
      items: ["Language: English/French", "UG/PG/College", "SDS & non-SDS"],
    },
    {
      title: "Exam Requirements",
      items: ["IELTS", "TOEFL", "PTE (many colleges)"],
    },
    {
      title: "Typical Costs",
      items: ["UG: 20k–45k CAD / year", "PG: 20k–40k CAD / year", "Living: 12k–20k CAD / year"],
    },
    {
      title: "Timeline & Visa",
      items: ["Intakes: Jan / May / Sep", "Apply 6–9 months early", "Study permit + biometrics"],
    },
    {
      title: "Requirements",
      items: ["Financial proof (GIC/fees)", "English score", "Academic transcripts", "Medical & insurance"],
    },
    {
      title: "Scholarships",
      items: ["University scholarships", "Provincial awards", "Entrance bursaries"],
    },
    {
      title: "Why Canada?",
      items: ["High quality of life", "Work while studying", "Post‑grad work permit", "Multicultural campuses"],
    },
  ];
...
<section className="relative w-full min-h-[550px] flex items-center justify-center overflow-hidden mb-0">
  {/* Background Image */}
  <img
    src="/country/canada2.jpeg"
    alt="Study in Canada hero"
  ...
  <div className="relative z-10 w-full px-6 lg:px-16 py-20 flex flex-col items-center text-center animate-slideUp">
    ...
    <p className="mt-4 max-w-2xl text-base sm:text-lg text-white/80">
      Explore universities, visa options, and everything you need to start your Canadian study journey.
    </p>
  </div>
  ...
  <div className="absolute bottom-0 left-0 w-full backdrop-blur-sm bg-white/[0.02] border-t border-white/5 py-4 animate-slideUpBreadcrumb">
    <nav className="max-w-7xl mx-auto px-6 lg:px-16 flex items-center gap-3 text-base sm:text-lg font-bold">
      ...
      <span className="text-[#a89fff] font-extrabold drop-shadow-[0_2px_8px_rgba(0,0,0,0.4)]">Canada</span>
    </nav>
  </div>
</section>
