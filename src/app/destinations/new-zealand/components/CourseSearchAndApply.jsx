...
const DATA = [
  ...
  },
  {
    ...
    logo: "/logos/auckland.png",
    tuitionFee: "31,500 NZD",
  ...
  },
  {
    ...
    logo: "/logos/massey.png",
    tuitionFee: "35,000 NZD",
    applicationFee: "NZD 0",
    duration: "36 months",
    intakes: "February",
    postStudyWork: true,
  ...
  {
    id: 4,
    title: "Master of Engineering Studies",
    institution: "University of Canterbury",
    logo: "/logos/canterbury.png",
    tuitionFee: "43,000 NZD",
    applicationFee: "NZD 100",
    duration: "18 months",
    intakes: "February, July",
    postStudyWork: true,
    ...
    <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 pt-2 text-center">
      <div className="mb-4 sm:mb-6">
        ...
        <p className="mt-1 text-sm sm:text-base text-[#4a4560] mb-10">
          Filter by intake, level, and discipline to find the right program and apply instantly.
        </p>
      </div>
      ...
      >
        <input
          ...
          placeholder="Search courses or universities in New Zealand..."
        />
        <select
          value={intake}
      ...
      <FormNZ open={showModal} course={selectedCourse} onClose={closeModal} />
    </div>
  );
}
