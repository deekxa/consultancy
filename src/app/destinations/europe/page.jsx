...
import CourseSearchAndApplyEurope from "./components/CourseSearchAndApplyEurope";
import FAQSectionEurope from "./components/FAQSectionEurope";
...
export default function EuropePage() {
  ...
  const cardConfig = [
    ...
    { title: "Exam Requirements", items: ["IELTS", "TOEFL", "Language-specific tests"] },
    { title: "Typical Costs", items: ["UG: 10k–35k", "PG: 15k–40k", "Living: 12k–25k"] },
    { title: "Timeline & Visa", items: ["Feb–Jun", "Sep–Dec", "Application → Visa"] },
    { title: "Requirements", items: ["Financial proof", "Language score", "Health insurance"] },
    { title: "Scholarships", items: ["Erasmus+", "DAAD", "University Merit-based"] },
    { title: "Why Europe?", items: ["Historic cities", "Cultural experience", "Travel-friendly", "High quality education"] },
  ];
...
<section className="relative w-full min-h-[550px] flex items-center justify-center overflow-hidden mb-0">
  ...
  <div className="relative z-10 w-full px-6 lg:px-16 py-20 flex flex-col items-center text-center animate-slideUp">
    ...
    <p className="mt-4 max-w-2xl text-base sm:text-lg text-white/80">
      Explore universities, visa options, and everything you need to start your Europe study journey.
    </p>
  </div>
  ...
  <div className="absolute bottom-0 left-0 w-full backdrop-blur-sm bg-white/[0.02] border-t border-white/5 py-4 animate-slideUpBreadcrumb">
    <nav className="max-w-7xl mx-auto px-6 lg:px-16 flex items-center gap-3 text-base sm:text-lg font-bold">
      ...
      <span className="text-[#a89fff] font-extrabold drop-shadow-[0_2px_8px_rgba(0,0,0,0.4)]">Europe</span>
    </nav>
  </div>
</section>
