...
import CourseSearchAndApplyJapan from "./components/CourseSearchAndApplyJapan";
import FAQSectionJapan from "./components/FAQSectionJapan";
...
export default function JapanPage() {
  ...
  const cardConfig = [
    { title: "Benefits", items: ["High-quality universities", "Innovative technology", "Cultural experience"] },
    { title: "Key Facts", items: ["Japanese", "UG/PG/Vocational", "Student visa"] },
    { title: "Exam Requirements", items: ["JLPT", "TOEFL", "IELTS"] },
    { title: "Typical Costs", items: ["UG: ¥1.2–2.5M", "PG: ¥1.5–3M", "Living: ¥100k–¥150k/month"] },
    { title: "Timeline & Visa", items: ["Apr–Jul", "Oct–Jan", "Application → Visa"] },
    { title: "Requirements", items: ["Financial proof", "Language score", "Acceptance letter", "Insurance"] },
    { title: "Scholarships", items: ["MEXT", "JASSO", "University scholarships"] },
    { title: "Why Japan?", items: ["Safe", "Advanced tech", "Cultural immersion", "Global opportunities"] },
  ];
  ...
  return (
    <main className="min-h-screen w-full bg-gradient-to-br from-[#fffaf0] via-[#f0f0ff] to-[#e8f0ff] relative">
<section className="relative w-full min-h-[550px] flex items-center justify-center overflow-hidden mb-0">
  <img
    src="/country/japan1.jpeg"
    alt="Study in Japan hero"
  ...
  <div className="relative z-10 w-full px-6 lg:px-16 py-20 flex flex-col items-center text-center animate-slideUp">
    ...
    <p className="mt-4 max-w-2xl text-base sm:text-lg text-white/80">
      Explore universities, visa options, and everything you need to start your Japan study journey.
    </p>
  </div>
  ...
  <div className="absolute bottom-0 left-0 w-full backdrop-blur-sm bg-white/[0.02] border-t border-white/5 py-4 animate-slideUpBreadcrumb">
    <nav className="max-w-7xl mx-auto px-6 lg:px-16 flex items-center gap-3 text-base sm:text-lg font-bold">
      ...
      <span className="text-[#a89fff] font-extrabold drop-shadow-[0_2px_8px_rgba(0,0,0,0.4)]">Japan</span>
    </nav>
  </div>
</section>
