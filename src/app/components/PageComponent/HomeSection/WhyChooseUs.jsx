...
import { FiAward, FiClock, FiHelpCircle, FiHeart, FiUsers, FiCheckCircle, FiBriefcase, FiTrendingUp, FiThumbsUp, FiGlobe, FiHeadphones, FiTarget } from 'react-icons/fi';
import FallbackImage from '../../ui/FallbackImage';

const features = [
  { icon: FiAward, title: 'Trusted university network', description: 'Carefully selected public and private institutions across key destinations.' },
  { icon: FiClock, title: 'Streamlined timelines', description: 'Fast responses on offers and visas so you can plan with confidence.' },
  { icon: FiHelpCircle, title: 'Guidance at every step', description: 'One team handling your profile from shortlisting to pre‑departure.' },
  { icon: FiHeart, title: 'Student‑first decisions', description: 'Recommendations based on fit, not on agency quotas or commissions.' },
];
...
export default function WhyChooseUs() {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-6xl mx-auto px-3 lg:px-6">
          <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
            {/* LEFT: big 3D circle + purple circle */}
            <div className="relative shrink-0 flex items-center justify-center">

              {/* softened big circle with subtle inset shadows */}
              <div
              ...
              {/* softened smaller purple circle with reduced shadow */}
              <div className="absolute left-[-18%] sm:left-[-16%] top-1/2 -translate-y-1/2">
                <div
                  className="relative w-36 h-36 sm:w-40 sm:h-40 rounded-full bg-linear-to-br from-[#110053] to-[#4f46e5] flex items-center justify-center shadow-[0_10px_20px_rgba(88,80,200,0.55)]"
                >
                  ...
                  <div className="relative text-center text-white px-3">
                    <p className="text-[10px] tracking-[0.22em] uppercase mb-1">WHY</p>
      ...
      <section aria-label="Statistics" className="bg-white py-12" style={{ paddingLeft: 0, paddingRight: 0 }}>
