...
export default function ContactPage() {
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      try {
        ...
        setStatus({
          ...
          success: true,
          message:
            "Enrollment request submitted! We will contact you within 24 hours.",
        });
        resetForm();
      } catch (err) {
  ...
  const whatsappMessage = encodeURIComponent(
    "Hi, I'd like to book a free consultation for studying abroad."
  );
      ...
      <section className="max-w-7xl mx-auto mt-24 px-6 text-center md:text-left flex flex-col md:flex-row items-center gap-12">
        <div className="flex-1 text-center md:text-left">
          ...
          <p className="text-lg md:text-xl text-[#4a4560] max-w-2xl leading-relaxed mb-6">
            Have questions about studying abroad? Our counselors are here to
          ...
          <div className="lg:col-span-1 space-y-12">
            <div className="group">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-lg font-bold text-[#110053] uppercase tracking-wider">
                  Call Us
                </h3>
              </div>
              <div className="pl-5 space-y-2 text-[#4a4560] text-lg">
                <p className="hover:text-[#8b7ae8] transition-colors cursor-pointer">
                  1 (234) 567-891
                </p>
                <p className="hover:text-[#8b7ae8] transition-colors cursor-pointer">
                  1 (234) 987-654
            ...
            <div className="group">
              ...
              <div className="pl-5 space-y-2 text-[#4a4560] text-lg">
                <p className="flex justify-between max-w-xs">
                  <span>Mon – Fri</span>
                  <span className="font-medium text-[#110053]">
                    10 am – 8 pm
                  </span>
                </p>
                <p className="flex justify-between max-w-xs">
            ...
            <div>
              <h3 className="text-lg font-bold text-[#110053] uppercase tracking-wider mb-6">
                Our Counselors
              </h3>
              ...
              <div className="space-y-8">
                <div className="group relative pl-6 border-l-2 border-transparent hover:border-[#8b7ae8] transition-colors">
                  ...
                  <div className="font-bold text-[#110053] text-xl mb-1">
                    Dr. Sita Sharma
                  </div>
                  <div className="text-[#8b7ae8] text-sm font-medium mb-2">
                    Senior Counselor
                  </div>
                  <div className="text-[#4a4560] text-sm">
                    Australia • UK • Canada
                  </div>
                </div>
            ...
            <div className="bg-white p-8 md:p-12 rounded-xl shadow-lg border border-[#e5e0ff]">
              <div className="mb-8">
                ...
                <p className="text-sm text-[#4a4560]">
                  ...
                  with batch details and payment information.
                </p>
              </div>
