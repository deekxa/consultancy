      ...
      <section className="relative w-full min-h-[550px] flex items-center justify-center overflow-hidden mb-0">
        ...
        <div className="absolute bottom-0 left-0 w-full backdrop-blur-sm bg-white/[0.02] border-t border-white/5 py-4 animate-slideUpBreadcrumb">
          <nav className="max-w-7xl mx-auto px-6 lg:px-16 flex items-center gap-3 text-base sm:text-lg font-bold">
            ...
            <span className="text-[#a89fff] font-extrabold drop-shadow-[0_2px_8px_rgba(0,0,0,0.4)]">
              Services
            </span>
          </nav>
        </div>
          ...
          <div className="rounded-2xl bg-white/90 border border-[#e5e0ff] px-5 py-4 sm:px-6 sm:py-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 shadow-sm">
            <div>
              ...
              <p className="text-sm sm:text-base text-[#4a4560]">
                We guide you through every critical phase: plan, apply, and
                arrive.
              </p>
            </div>
            <ol className="flex flex-wrap gap-3 text-xs sm:text-sm text-[#4b5563]">
              <li className="flex items-center gap-2">
                <span className="h-6 w-6 rounded-full border border-[#8b7ae8] flex items-center justify-center text-[11px] text-[#8b7ae8]">
                  1
                </span>
                Plan your path
              </li>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-10 items-center">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-sm sm:text-base text-[#4a4560] mb-4">
              Personalized sessions to uncover your strengths, clarify your
              education and immigration goals, and select the right country,
              course, and intake.
            </p>
            <ul className="space-y-1.5 text-sm text-[#4b5563]">
              <li>
                • 1:1 career counseling aligned with future work/PR
                opportunities.
              </li>
              <li>
                • Course and major selection based on academics, budget, and
                destination preferences.
              </li>
              <li>
                • Advice on realistic timelines for English tests, applications,
                and visas.
              </li>
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="text-sm sm:text-base text-[#4a4560] mb-4">
              Tailored shortlist based on your real profile, budget, city
              preferences, scholarships, and visa odds—not random Google
              results.
            </p>
            <ul className="space-y-1.5 text-sm text-[#4b5563]">
              <li>
                • Realistic profile assessment to filter options and avoid
                wasted effort.
              </li>
              <li>
                • Balanced “safe, match, and reach” list for best chances.
              </li>
              <li>
                • Clear explanations of entry requirements, fees, and
                scholarships.
              </li>
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-10 items-center">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-sm sm:text-base text-[#4a4560] mb-4">
              Complete guidance from SOP drafts to final visa—so you submit
              strong, mistake-free files and maximize approval chances.
            </p>
            <ul className="space-y-1.5 text-sm text-[#4b5563] mb-4">
              <li>• SOP/personal statement strategy, feedback, and editing.</li>
              <li>
                • All documentation—recommendation letters, transcripts,
                translations, forms.
              </li>
              <li>• Scholarship and financial aid support where available.</li>
              <li>
                • Full visa checklist, bank/financial review, GTE statements,
                and interview prep.
              </li>
            </ul>
          </div>
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="text-sm sm:text-base text-[#4a4560] mb-4">
              Small group classes focusing on exactly the skills and strategy
              you need for the scores your offer and visa require.
            </p>
            <ul className="space-y-1.5 text-sm text-[#4b5563]">
              <li>• Diagnostic test to identify weak areas.</li>
              <li>
                • Module-by-module lessons, regular mock tests, and personalised
                feedback.
              </li>
      ...
      <section className="py-16 pb-20">
        <div className="max-w-6xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-10 items-center">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-sm sm:text-base text-[#4a4560] mb-4">
              Everything you need for a smooth landing—step-by-step checklists,
              briefings, and on-ground support.
            </p>
            <ul className="space-y-1.5 text-sm text-[#4b5563] mb-4">
              <li>
                • Pre-departure seminar: packing, documents, airport process,
                and cultural tips.
              </li>
              <li>
                • Help arranging accommodation, SIMs, banking, local transport,
